...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout flContent) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentMainBinding((ConstraintLayout) rootView, flContent);
    }
